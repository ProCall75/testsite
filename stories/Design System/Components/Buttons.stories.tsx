    ...
    <div className="space-y-8">
      ...
      <div className="mt-8 p-4 bg-muted rounded-lg">
        ...
        <ul className="text-sm text-muted-foreground space-y-1">
          ...
          <li>• <code className="px-1 py-0.5 bg-background rounded text-xs">glass-secondary</code> : Actions principales (CTA)</li>
          <li>• <code className="px-1 py-0.5 bg-background rounded text-xs">glass-blue</code> : Actions d'accentuation</li>
